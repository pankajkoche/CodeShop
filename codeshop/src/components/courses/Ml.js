...
const Ml = () => {
    ...
    return (
        ...
        <main className=' flex rounded-lg'>
            {/*Sidebar*/ }
            <LeftMenu/>

            {/* Content */}
            <div className='flex-grow    mx-3 bg-white rounded-lg
                            overflow-y-scroll scrollbar-hide h-screen
                             '>
                <header className=' flex items-center w-full justify-center py-6 bg-orange-200  rounded-lg '>
                    <div>
                        <img src= {mlImg} className=' px-5 h-10 w-15'/>
                    </div>
                    <div className=''>
